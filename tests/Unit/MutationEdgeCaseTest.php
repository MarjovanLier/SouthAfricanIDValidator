...
final class MutationEdgeCaseTest extends TestCase
{
    ...
    public function testCenturyArrayRequires1800s(): void
    {
        ...
        self::assertTrue($result, '000229 is valid as 1900-02-29 or 2000-02-29');
        ...
        self::assertTrue($result, 'ID with ambiguous century should validate');
    }
    ...
    public function testLuhnAdditionIsEssential(): void
    {
        ...
        $result = SouthAfricanIDValidator::luhnIDValidate($idNumber);
        self::assertTrue($result, 'High digit ID requires addition not subtraction');
        ...
        self::assertTrue($result2, 'Alternating pattern requires addition');
    }
    ...
    public function testLuhnNeedsIntegerCast(): void
    {
        ...
        $result = SouthAfricanIDValidator::luhnIDValidate($idNumber);
        self::assertTrue($result, 'Luhn needs integer math for digit reduction');

        // Test with zeros - string "0" behaves differently than int 0
        $id2 = '0001010000006'; // Mostly zeros with valid checksum
        $result2 = SouthAfricanIDValidator::luhnIDValidate($id2);
        self::assertTrue($result2, 'Zeros need integer casting');
    }
    ...
    public function testGenderNeedsIntegerComparison(): void
    {
        ...
        self::assertSame('female', $gender3, 'String "0999" > "5000" but int 999 < 5000');
    }
    ...
    public function testConvertLegacyValidationStrictness(): void
    {
        ...
        self::assertNull($result, 'Invalid checksum returns null');
        ...
        self::assertNull($result2, 'Invalid citizenship returns null');
        ...
        self::assertSame($modernId, $result3, 'Modern ID returns unchanged');
        ...
        self::assertIsString($result4, 'Valid legacy converts');
        self::assertSame('8001015009087', $result4, 'Conversion is correct');
    }
    ...
    public function testExtractInfoValidationStates(): void
    {
        ...
        self::assertTrue($idValidationResult['valid'], 'Valid ID has valid=true');
        self::assertIsArray($idValidationResult['date_components'], 'Has date components');
        ...
        self::assertFalse($info2['valid'], 'Invalid checksum has valid=false');
        self::assertNull($info2['date_components'], 'No date components');
        ...
        self::assertFalse($info3['valid'], 'Invalid citizenship has valid=false');
        self::assertNull($info3['date_components'], 'No date components');

        // Too short - does not pass length check
        $tooShort = '800101500908';
        $info4 = SouthAfricanIDValidator::extractInfo($tooShort);
        self::assertFalse($info4['valid'], 'Too short has valid=false');
    }
    ...
    public function testConvertLegacyBitShiftLogic(): void
    {
        ...
        self::assertIsString($result, 'Conversion succeeds');

        // Verify the checksum was recalculated correctly
        $isValid = SouthAfricanIDValidator::luhnIDValidate($result);
        self::assertTrue($isValid, 'Converted ID has valid checksum');
    ...
    public function testConvertLegacyStringCasting(): void
    {
        ...
        self::assertIsString($result8, 'Returns string');
        self::assertSame('8001015009087', $result8, 'Casts 8 to string correctly');

        // Test with integer 9
        $result9 = SouthAfricanIDValidator::convertLegacyToModern($legacyId, 9);
        self::assertIsString($result9, 'Returns string');
        self::assertSame('8001015009095', $result9, 'Casts 9 to string correctly');
    }
